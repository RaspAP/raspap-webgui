    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <ul class="nav nav-tabs">
          ...
          <li class="nav-item"><a class="nav-link" href="#aboutcookbook" data-bs-toggle="tab"><?php echo _("Cookbook"); ?></a></li>
        ...
        <div class="tab-content">
          ...
          <?php echo renderTemplate("about/cookbook", $__template_data) ?>
