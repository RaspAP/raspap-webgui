(function ($, _t) {
  ...
  function ShowBandwidthChartHandler(e) {
    ...
    var timeunit = $("ul#tabbarBandwidth li.nav-item a.nav-link.active")
      .attr("href")
      .substr(1);
    var uri = "ajax/bandwidth/get_bandwidth.php?";
    uri += "inet=";
    uri += encodeURIComponent(
      $("#cbxInterface" + timeunit + " option:selected").text(),
    );
    uri += "&tu=";
      ...
      .done(function (jsondata) {
        ...
        $("#tableBandwidth" + timeunit).DataTable({
          ...
          columns: [
            ...
            {
              data: "rx",
              title: _t["receive"] + " " + datasizeunits.toUpperCase(),
            },
            {
              data: "tx",
              title: _t["send"] + " " + datasizeunits.toUpperCase(),
            },
          ],
        });
      })
  ...
  $(document).ready(function () {
    $('#tabbarBandwidth a[data-toggle="tab"]').on(
      "shown.bs.tab",
