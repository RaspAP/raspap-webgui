...
function install_dependencies() {
    ...
    sudo apt-get install $apt_option lighttpd $php_package git hostapd dnsmasq vnstat qrencode php-apcu php-apcu-bc || install_error "Unable to install dependencies"
}
